...
//     public static RelativeEncoder m_climberEncoder;
    ...
    */
    public ClimberSubsystem(){
        ...
        m_climberMotorR.setSoftLimit(CANSparkMax.SoftLimitDirection.kReverse, 0);
        ...
        m_climberMotorL.setSoftLimit(CANSparkMax.SoftLimitDirection.kReverse, 0);
  ...
  @Override
    ...
    public Boolean climbCmd(){
        ...
        if (m_climberEncoderR.getPosition() == 0 && m_climberEncoderR.getPosition() == 0){
          return climbed = true;
        }
        return climbed;
    }
